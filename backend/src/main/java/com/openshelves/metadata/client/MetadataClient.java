package com.openshelves.metadata.client;
...
public interface MetadataClient {
    ...
    ///
    /// @return a list of matching [BookMetadata] results; never `null`, may be empty
    List<BookMetadata> fetchBooks(BookRequest request, FetchOptions fetchOptions);
    ...
    /// @param fetchOptions controls result limits and language filtering
    ///
    /// @return a list of matching [AuthorMetadata] results; never `null`, may be empty
    List<AuthorMetadata> fetchAuthors(AuthorRequest request, FetchOptions fetchOptions);
