...
public class ExternalBook {
     ...
     *
     * <p>Only minimal identifying information is included here. Full author
     * details are expected to be resolved separately.</p>
     */
    @Builder.Default
     ...
     *
     * <p>This is not a full author representation—only the minimum data required
     * to establish a relationship between a book and a contributor.</p>
     */
    @Data
    @Builder
    @NoArgsConstructor
